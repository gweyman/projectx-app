  ...
  return (
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '24px', textAlign: 'center', backgroundColor: '#0a0a0a' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%', maxWidth: '280px' }}>
        ...
        <Link href="/login" style={{ display: 'block', padding: '16px', textAlign: 'center', fontSize: '12px', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 700, border: '1px solid #333', color: '#666', borderRadius: '6px', textDecoration: 'none' }}>
          Sign In
        </Link>
      </div>
    </main>
